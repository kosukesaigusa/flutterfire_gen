...
///
/// - Fetch single or multiple [Todo] documents ([fetchDocuments], [fetchDocument]).
/// - Subscribe to real-time updates of single or multiple [Todo] documents ([subscribeDocuments], [subscribeDocument]).
