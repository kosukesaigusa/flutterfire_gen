...
作成専用のインターフェースや作成処理の詳細については [ドキュメントを作成する](/create-document) を参照してください。
...
更新専用のインターフェースや更新処理の詳細については [ドキュメントを更新する](/update-document) を参照してください。
...
削除処理の詳細については [ドキュメントを削除する](/delete-document) を参照してください。
