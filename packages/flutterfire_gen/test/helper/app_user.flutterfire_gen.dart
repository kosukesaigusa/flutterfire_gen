...
/// operations on appUser documents, along with additional utilities like counting
/// documents, and calculating sum and average values for specific fields.
///
/// It includes methods to:
///
/// - Fetch single or multiple [ReadAppUser] documents ([fetchDocuments], [fetchDocument]).
/// - Subscribe to real-time updates of single or multiple [ReadAppUser] documents ([subscribeDocuments], [subscribeDocument]).
/// - Count documents based on queries ([count]).
/// - Calculate sum ([getSum]) and average ([getAverage]) of specific fields across documents.
/// - Add ([add]), set ([set]), update ([update]), and delete ([delete]) appUser documents.
///
...
/// Usage:
///
/// - To fetch or subscribe to appUser documents, or to count them, use the corresponding fetch, subscribe, and count methods.
/// - To modify appUser documents, use the methods for adding, setting, updating, or deleting.
...
/// a straightforward API for appUser document operations.
class AppUserQuery {
  ...
  /// Counts the number of appUser documents in Cloud Firestore.
  ///
